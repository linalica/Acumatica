...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" Runat="Server">
    <px:PXGrid ID="grid" runat="server" DataSourceID="ds" Style="z-index: 100" 
		Width="100%" Height="150px" SkinID="Inquire" TabIndex="2700" TemporaryFilterCaption="Filter Applied">
		<Levels>
			<px:PXGridLevel DataKeyNames="OrderNbr" DataMember="Orders">
			    <Columns>
                    ...
                    <px:PXGridColumn DataField="Hold" TextAlign="Center" Type="CheckBox" Width="60px">
                    </px:PXGridColumn>
                    ...
                    <px:PXGridColumn DataField="LinesTotal" TextAlign="Right" Width="100px">
                    </px:PXGridColumn>
                    <px:PXGridColumn DataField="TaxTotal" TextAlign="Right" Width="100px">
                    </px:PXGridColumn>
