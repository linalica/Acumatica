...
function attachEventHandlers()
{
	...
	{
		if (frameHelper.__designMode) return;
		if (!$("#navMenu").is(":visible") || !$("#navMenu").hasClass("search-mode"))
	...
	frameHelper.registerDropDown("txtWsIcon", __availableIcons, IconsList);
	frameHelper.registerDropDown("txtTileIcon", __availableIcons, IconsList);
	frameHelper.registerDropDown("txtCatIcon", __availableIcons, IconsList);
...
var frameHelper =
{
	...
	showPanel: function (id, params, values)
	{
		...
		else
		{
			...
			panel.find("div[data-icon]").each(function (index, elem)
			{
				$("#" + $(elem).attr("data-icon")).removeAttr("class");
			});
		}
	},
...
window.MenuModules = React.createClass(
{
	onClick: function (e)
	{
		...
		return React.DOM.div(divAttr,
			items.map(function (m)
			{
				...
				return React.DOM.div(attrs,
					React.DOM.i({ className: "ac ac-fw ac-" + (m.Icon ? m.Icon : "file-o") }),
					React.DOM.span({ className: "text" }, m.Title),
					//(designMode || !showAll) ? null :
					//	React.DOM.i({ className: "ac ac-pull-right fav-icon ac-" + favIcon, onClick: onClickFav }),
					designMode && m.Deletable ? React.DOM.i({ className: "ac ac-close ac-fw", "data-erole": "remove" }) : null,
					designMode ? React.DOM.i({ className: "ac ac-mode_edit ac-fw", "data-erole": "edit" }) : null
				)
			}),
...
window.TopLinks = React.createClass(
{
	onClick: function (e)
	{
	...
	render: function ()
	{
		...
		var itemsDOM = items.map(function (m)
		{
			...
			return React.DOM.a(attrs,
				React.DOM.i({ className: "ac ac-" + m.Icon + (iconRight ? " ac-pull-left" : "") }),
				iconRight ? null : React.DOM.br(null), React.DOM.span({ className: "text" }, m.Title),
				designMode ? null : React.DOM.i({ className: "ac ac-fw ac-" + favCss, "data-erole": "fav" }),
				designMode ? React.DOM.i({ className: "ac ac-close ac-fw", "data-erole": "remove" }) : null,
				designMode ? React.DOM.i({ className: "ac ac-mode_edit ac-fw", "data-erole": "edit" }) : null
			);
		});
		...
		return React.DOM.div(divAttr, itemsDOM);
	},
...
//-----------------------------------------------------------------------------
// one menu column
window.MenuColumn = React.createClass(
{
	onClick: function (e)
	{
	...
	render: function ()
	{
		...
		return React.DOM.div(null, items.map(function (l)
		{
			...
			{
				return renderDesignIcons ? React.DOM.i({
			...
			return screens.length == 0 ? null : React.DOM.div(props,
				React.DOM.h3(null,
					l.Icon ? React.DOM.i({ className: "ac ac-fw ac-" + l.Icon }) : null,
					l.Name.replace("&nbsp;", "\u00a0")
				),
				screens.map(function (s)
				{
					...
					return React.DOM.a(attrs,
						renderDesignIcons ? React.DOM.i({ className: "ac drag-icon ac-more_vert" }) : null,
						React.DOM.i({
							className: "ac fav-icon " + favIcon, onClick: (selectMode || showPin) ? null : onClickFav,
							style: renderFav ? null : { visibility: "hidden" }
						}),
						React.DOM.span({ className: "text", dangerouslySetInnerHTML: { __html: text } }),
...
//-----------------------------------------------------------------------------
// all menu columns
window.ModuleMenu = React.createClass(
{
	render: function ()
	{
		...
		var colsDOM = columns.map(function (i)
		{
			...
			return (list && list.length > 0) ?
				React.DOM.div({ "data-col": i }, React.createElement(MenuColumn, { items: list, searchString: searchStr,
					showFav: showFav, showPin: showPin, selectMode: selectMode, onDragStart: onDragStart })) : null;
		});
		...
		return React.DOM.div(divAttr, colsDOM, React.DOM.div({ className: "clear-float" }));
	},
		...
		return React.DOM.div(null,
			React.DOM.div(null,
				items.map(function (m)
				{
					...
					return [React.DOM.div({ className: "module-name" },
						React.DOM.i({ className: "ac ac-" + (m.Icon ? m.Icon : "file-o") }),
						React.DOM.span({ className: "text" }, m.Title)),
...
window.SearchNotFound = React.createClass(
{
	render: function ()
	{
		var selectMode = this.props.selectMode;
		return React.DOM.div({ className: "search-failed" },
			React.DOM.div(null, frameHelper.getLocalString("searchWarn1"), React.DOM.span({ className: "text" }, this.props.text + '.')),
			React.DOM.br(), 
			React.DOM.div(null, frameHelper.getLocalString("searchWarn2")),
			React.DOM.ul(null,
				React.DOM.li(null, frameHelper.getLocalString("searchWarn3")),
				React.DOM.li(null, frameHelper.getLocalString("searchWarn4")),
				React.DOM.li(null, frameHelper.getLocalString("searchWarn5")),
				selectMode ? React.DOM.li(null, frameHelper.getLocalString("searchWarn6"), React.DOM.br(),
...
//-----------------------------------------------------------------------------
// icons list class
window.IconsList = React.createClass(
{
	render: function ()
	{
		...
		return React.DOM.ul({ className: "", id: "imagesMenu" },
			items.map(function (m)
			{
				return React.DOM.li({ key: m, "data-value": m },
					React.DOM.i({ className: ("ac ac-" + m) }), React.DOM.a(null, m.replace(/_/g, ' ')));
			}));
	}
});

// strings list class
window.StringList = React.createClass(
{
	render: function ()
	{
		var items = this.props.items, searchStr = this.props.searchString;
		...
		return React.DOM.ul(null,
			items.map(function (m)
			{
				return React.DOM.li({ key: items.indexOf(m), "data-value": m }, React.DOM.a(null, m));
			}));
	}
});
...
window.ItemsList = React.createClass(
{
	render: function ()
	{
		...
		return React.DOM.ul(null,
			items.map(function (m)
			{
				return React.DOM.li({ key: items.indexOf(m), "data-value": m[id], "data-text": m[text] },
					React.DOM.a(null, m[text]));
			}));
	}
});

// screens list class
window.ScreensList = React.createClass(
{
	render: function ()
	{
		...
		return React.DOM.ul({ className: "", id: "screensMenu" },
			items.map(function (m)
			{
				return React.DOM.li({ key: m.NodeID, "data-value": m.ScreenID, "data-text": m.Title },
					React.DOM.a(null, m.ScreenID + ' - ' + m.Title));
			}));
	}
});
...
//-----------------------------------------------------------------------------
// categories panel
window.CategoriesList = React.createClass(
{
	...
	render: function ()
	{
		...
		return React.DOM.div(divAttr,
			items.map(function (cat)
			{
				...
				return React.DOM.div(attrs,
					cat.Icon ? React.DOM.i({ className: ("ac ac-fw ac-" + cat.Icon) }) : null,
					React.DOM.span({ className: "text" }, cat.Name),
					cat.Deletable ? React.DOM.i({ className: "ac ac-close ac-fw", "data-erole": "remove", onClick: onClickCat }) : null,
					React.DOM.i({ className: "ac ac-mode_edit ac-fw", "data-erole": "edit", onClick: onClickCat })
				);
			}));
	},
...
//-----------------------------------------------------------------------------
// entity panel
window.EntityList = React.createClass(
{
	onNext: function (e)
	{
	...
	render: function ()
	{
		...
		return React.DOM.div({ className: "list-group entity" },
			items.map(function (item)
			{
				...
				return React.DOM.a(attrs,
					React.DOM.div({ className: "title", dangerouslySetInnerHTML: { __html: item.Title }}),
					item.Line1 ? React.DOM.div({ className: "text", dangerouslySetInnerHTML: { __html: item.Line1 } }) : null,
					item.Line1 ? React.DOM.div({ className: "text", dangerouslySetInnerHTML: { __html: item.Line2 }}) : null,
					item.Text ? React.DOM.div({ className: "text", dangerouslySetInnerHTML: { __html: item.Text } }) : null
				);
			}),
			React.DOM.div({ className: "pager" },
				React.DOM.div({ className: 'arrow' + nextCss, onClick: nextCss ? this.onNext: null}, 'NEXT',
					React.DOM.i({ className: "ac ac-keyboard_arrow_right"})),
				React.DOM.div({ className: 'arrow' + prevCss, onClick: prevCss ? this.onPrev : null },
					React.DOM.i({ className: "ac ac-keyboard_arrow_left" }), 'PREV')
			));
	}
});
...
window.ModulesLinks = React.createClass(
{
	onClick: function(e)
	{
	...
	render: function ()
	{
		...
		return React.DOM.div({ className: "workspaces", onClick: onClick },
		list.map(function(a)
		{
			return [React.DOM.div({ className: "module-name" }, a.Name),
				a.Modules.map(function (m)
				{
					var url = "javascript: void 0";
					return React.DOM.a({ href: url, "data-id": m.WorkspaceID },
						React.DOM.i({ className: "ac ac-" + m.Icon }), React.DOM.br(null), m.Title,
						React.DOM.i({ className: "ac ac-pin ac-rotate-90", "data-erole": "pin", onClick: onClickRole }));
				})
			]
		}));
	}
...
//-----------------------------------------------------------------------------
// wiki links
window.WikiLinks = React.createClass(
{
	onClick: function (e)
	{
	...
	render: function ()
	{
		...
		return React.DOM.div({ className: "wikies", onClick: onClick },
			list.map(function (w)
			{
				var descr = w.Description ? w.Description : "Some text explaining the content of the article.";
				return React.DOM.div(null,
					React.DOM.span({ className: "title" }, w.Title), React.DOM.br(null),
					descr ? React.DOM.span({ className: "descr" }, descr) : null,
					descr ? React.DOM.br(null) : null,
					React.DOM.a({ href: url, 'data-id': w.PageID, 'data-url': w.DefaultUrl },	frameHelper.getLocalString("explore"))
				);
			}));
	}
});
	...
	Dropdown.prototype.menuClick = function (e)
	{
		...
		else if ((val = $this.attr('data-value')) != null)
		{
			...
			if (menu)
			{
				...
				{
					target = $('#' + target);
					target.removeAttr("class");	target.addClass("ac ac-" + val);
				}
			}
		}
