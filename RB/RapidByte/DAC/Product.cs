namespace RB.RapidByte
{
    ...
    public class ProductReorder : Product
    {
        ...
        [PXDBCalced(
             typeof(Minus<Sub<IsNull<Product.availQty, decimal_0>,
             Product.minAvailQty>>),
             typeof(Decimal))]
        ...
        [PXDBScalar(typeof(Search<SupplierProduct.supplierID,
             Where<SupplierProduct.productID,
                 Equal<Product.productID>>,
             OrderBy<Asc<SupplierProduct.supplierPrice>>>))]
        [PXSelector(
             typeof(Search2<Supplier.supplierID,
             InnerJoin<SupplierProduct, On<SupplierProduct.supplierID,
             Equal<Supplier.supplierID>>>,
             Where<SupplierProduct.productID,
             Equal<Current<ProductReorder.productID>>>>),
